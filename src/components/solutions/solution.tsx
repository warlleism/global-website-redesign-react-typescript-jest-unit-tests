        ...
        <StyledContainer>
            <div
                ...
                <div className="flex flex-col items-center justify-center">
                    <div className="lg:text-[2.6rem] font-bold">Prepare-se para o <span className=" text-[#0096FB]">sucesso</span> digital!</div>
                ...
                >
                    {RenderSolutions.map((item) => (
                        <div
                            ...
                            className="relative overflow-hidden w-full h-[380px] lg:h-[600px] md:w-[280px] lg:w-[270px] 2xl:w-[360px] flex-shrink-0 rounded-[30px] flex justify-center items-center grayscale-[100%] hover:grayscale-[0%] transition-all duration-300"
